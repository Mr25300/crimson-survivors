...
export class ShaderProgram {
  ...
  /**
   * Sets the uniform int as either 0 or 1 depending on a boolean.
   * @param name The uniform name.
   * @param bool The boolean.
   */
  public setUniformBool(name: string, bool: boolean): void {
    this.gl.uniform1i(this.getUniformLocation(name), bool ? 1 : 0);
  }

  /**
   * Sets the uniform float 3 vector as a color.
   * @param name The uniform name.
   ...
   */
  public setUniformVector(name: string, vector: Vector2): void {
